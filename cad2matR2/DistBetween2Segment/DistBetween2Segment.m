...
function [distance, ClosePoint] = DistBetween2Segment(p1, p2, p3, p4)
    ...
    ClosePoint(1,:) = {outV};      % vector connecting the closest points
    ClosePoint(2,:) = {p2+sc*u};   % Closest point on object 1 
    ClosePoint(3,:) = {p4+tc*v};   % Closest point on object 2
