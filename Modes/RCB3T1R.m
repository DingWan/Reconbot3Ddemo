...
%     end
    ...
    methods
        ...
        function [p, EulerAngle_q11_theta, ABC, q1q2] = RCB_3T1R_IK(obj)
            ...
            if isequal(p_BinaryCode, [1 1 1 1 0 0]) == 1 % 3T1R mode
                ...
                if abs(C1_in_Ob(1) - A1(1)) <= 1e-2 && abs(C1_in_Ob(2) - A1(2)) <= 1e-2 && abs((C2_in_Ob(1) - A2(1)) > 1e-2 || abs(C2_in_Ob(2) - A2(2)) > 1e-2)
                    display('Notice:The 1st+5th axes of C1A1 overlapped (Please improve in the future!!!)')
                ...
                elseif abs(C2_in_Ob(1) - A2(1)) <= 1e-2 && abs(C2_in_Ob(2) - A2(2)) <= 1e-2 && abs((C1_in_Ob(1) - A1(1)) > 1e-2 || abs(C1_in_Ob(2) - A1(2)) > 1e-2)
                    display('Notice:The 1st+5th axes of C2A2 overlapped (Please improve in the future!!!)')
                    display('The solution can be decided by straties like(eg.2): ')
                    display('1.Follow the angle of previous or next steps;')
          ...
          %% ----------------------- Calculate solutions for one input  -----------------------            
            ...
            for i = 1:1:IterationNumber
                ...
                %EulerAngle_q11_theta_ABC_q1q2 = {EulerAngle_q11_theta, ABC, q1q2};
