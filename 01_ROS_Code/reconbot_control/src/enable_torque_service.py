...
def enable_torque(req):
    ...
    if req.motor_state == 1:
        ...
        valueTuples = ((4,0),(5,1),(3,0),(1,1),(2,1),(6,1))
        motors.set_multi_torque_enabled(valueTuples)
        state = True
    elif req.motor_state == 3:
        valueTuples = ((4,1),(5,1),(3,1),(1,0),(2,1),(6,0))
        motors.set_multi_torque_enabled(valueTuples)
        state = True
        ...
        valueTuples = ((4,0),(5,1),(3,0),(1,1),(2,0),(6,1))
        motors.set_multi_torque_enabled(valueTuples)
        state = True
    elif req.motor_state == 6:
        valueTuples = ((4,1),(5,1),(3,1),(1,0),(2,0),(6,1))
        motors.set_multi_torque_enabled(valueTuples)
        state = True
    else:
