...
% ---------------------- 
    ...
    for x = -70 : 1 : 80
        for y = 10 : 1 : 80
            ...
            [p_previous,  ~, ~, q1q2_all, WSvalue] = obj2RserialA2C2.RCB_2R_SerialA2C2_IK;            
            if WSvalue(1) == 0 && WSvalue(2) == 0 && WSvalue(2) == 0
                continue
            end
            ...
            JT_inv = inv(J_Ob_2RserialA2C2');
            %Tor_q1q2 = JT_inv * [ 10 7 0 0 0 0 ]';
            
            % ------ 2RserialA2C2 redundent ------
            % Jx2_Ob_2RserialA2C2_r = [
            %                             Jx2_Ob(1,:)
            %                             Jx2_Ob(2,:)
            %                             Jx2_Ob(3,:)
            %                             Jx2_Ob(4,:)
            %                         ];
            % Jq2_Ob_2RserialA2C2_r = [  Jq2_1_Ob   0          0           0
            %                            0          Jq2_2_Ob   0           0
            %                            0          0          Jq2_3_Ob    0
            %                            0          0          0           Jq2_4_Ob
            %                         ];
            %det(Jx2_Ob_2T2Rsixbar_r)
            % Ja_Ob_2RserialA2C2_r = inv(Jq2_Ob_2RserialA2C2_r) * Jx2_Ob_2RserialA2C2_r;
            % J_Ob_2RserialA2C2_r = [
            %                         Ja_Ob_2RserialA2C2_r;
            %                         Jc_Ob(2,:);
            %                         Jc_Ob(6,:);
            %                         Jc_Ob(7,:);
            %                         Jc_Ob(8,:);
            %                       ]
            %
            % JT_plus = J_Ob_2RserialA2C2_r * inv(J_Ob_2RserialA2C2_r' * J_Ob_2RserialA2C2_r);
            % Tor_q1q2 = JT_plus  * [ 18 10 0 0 0 0 ]' %/1000
            ...
            while( abs(Tor_q11) < TorUpBo && abs(Tor_q12) < TorUpBo && abs(Tor_q14) < TorUpBo &&...
                ...
                %Tor_q1q2 = JT_plus * [ 1 1 1 Fx Fy Fz ]';
                Tor_q1q2 = JT_inv * [ Tau_x 0 0 0 0 0 ]';
            ...
            while( abs(Tor_q11) < TorUpBo && abs(Tor_q12) < TorUpBo && abs(Tor_q14) < TorUpBo &&...
                ...
                %Tor_q1q2 = JT_plus * [ 1 1 1 Fx Fy Fz ]';
                Tor_q1q2 = JT_inv * [ 0 Tau_y 0 0 0 0 ]';
            ...
            Tau_x_y_theta_phi(j_phi,:) = [ Tau_x Tau_y x y ];
            %Tor_q1q2_Max(j_phi,:) = Tor_q1q2(1:4);
        end
    end
    close(h)
    
    Tau_x_y = Tau_x_y_theta_phi(:,1:2);
    figure(2)
    plot(Tau_x_y(:,1), Tau_x_y(:,2), 'b.')
    xlabel('x');
    ylabel('y');
    grid on  
    axis equal
