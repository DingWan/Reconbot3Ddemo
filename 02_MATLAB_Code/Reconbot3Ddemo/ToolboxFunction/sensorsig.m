function [xOut, xcov_t, xcov] = sensorsig(pos_in,Nsnapshots,ang_in,varargin)
...
if nargout > 1
    xcov_t = sv*scov*sv' + ncov;
    xcov_t = (xcov_t+xcov_t')/2;  % ensure Hermitian
end
...
if nargout > 2
    ...
    xcov = xOut.'*conj(xOut)/Nsnapshots;
