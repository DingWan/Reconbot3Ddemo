function w = cbfweights(pos_in,ang_in)
...
[pos,ang,N_ele] = parseInput(pos_in,ang_in);

w = phased.internal.steeringvec(pos,1,1,ang)./N_ele;


%---------------------------------
function [pos,ang,N_ele] = parseInput(pos_in,ang_in)
