...
if isempty(coder.target)
    par = inputParser;
    par.addParamValue('RangeUnit', defaultRangeUnit);
    par.addParamValue('HeightUnit', defaultHeightUnit);
    par.addParamValue('Polarization', defaultPolarization);
    par.addParamValue('SurfaceDielectric', defaultSurfaceDielectric);
    par.addParamValue('SurfaceRoughness', defaultSurfaceRoughness);
    par.addParamValue('AntennaPattern', defaultAntennaPattern); % Vector
    par.addParamValue('PatternAngles', defaultPatternAngles);  % Vector
    par.addParamValue('TiltAngle', defaultTiltAngle);
    par.addParamValue('MaxElevation', defaultMaxElevation); 
