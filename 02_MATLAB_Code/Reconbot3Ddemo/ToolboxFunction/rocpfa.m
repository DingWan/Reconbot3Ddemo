...
defaultNumPulses = 1;
 ...
 if isempty(coder.target)
     p = inputParser;
     p.addParamValue('SignalType',defaultSignalType);   
     p.addParamValue('MinSNR',defaultMinSNR); 
     p.addParamValue('MaxSNR',defaultMaxSNR); 
     p.addParamValue('NumPoints',defaultNumPoints);  
     p.addParamValue('NumPulses',defaultNumPulses);  
     p.parse(varargin{:});
