classdef RCB2T2Rfivebar
    ...
    methods
        function obj = RCB1T3RRotAroundPoint(pos,q11q12q14q22,L1,L2)
            if nargin > 0
                obj.l1 = L1;
                obj.l2 = L2;
                obj.pos = pos;
        ...
        function [p, EulerAngle_q11_theta, ABC, q1q2_FiveBar] = RCB_2T2R_FiveBar_IK(obj)
            ...
            if isequal(p_BinaryCode, [1 1 1 0 0 0]) == 1
                ...
                % Euler angle IK
                if isequal(p_BinaryCode, [1 1 1 0 1 1]) == 1
                    % Mechanism transfers into Planar five-bar Linkage:  [1 1 1 1 1 1]
                    % p = [x, 0, z, 0, beta, 0]
                    display('Notice: Inputs are: p = [x, 0, z, [], beta, 0]');
                    display('Mechanism transfers into Planar five-bar Linkage');
