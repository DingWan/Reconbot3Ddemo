...
% MotorPosition = [30*pi/180, -30*pi/180, -90*pi/180, 10*pi/180, 0*pi/180, 180*pi/180];
% q0 = 0;
...
for ii = 1:3
    ...
    if ii == 1 || ii == 3
        if ii == 1
            ...
            Mode_Pos_Ori_TrajPoints_cell{2} = { 12, {0 0 0 [] [] [], 0 ,0, 0, 0},q0q1q2_FixedMode};
        elseif ii == 3
            q1q2 = q0q1q2_Pos_mat(NumIntepoPoints*2,2:11);
            Mode_Pos_Ori_TrajPoints_cell{1} = { 1, {0 147.7 147.7 0 [] [], 0 ,0},q0q1q2_RectagularPosition};
            Mode_Pos_Ori_TrajPoints_cell{2} = { 1, {0 0 208.879343162506 0 [] [], 0 ,0},q0q1q2_HomePosition};
        end
        % First step: Calculate the next step and get the second row values of q11 and q21 after
        % intepolation, and assign to the previous step.0
        % Assgin Input value
        ...
        [ PosOri_Output, q0q1q2_P2P_Pos_Intep_HomePosition, q0q1q2_P2P_Vel_Intep_HomePosition ,q0q1q2_P2P_Acc_Intep_HomePosition, ...
            MP_Pos_Intep_HomePosition, MP_Vel_Intep_HomePosition, MP_Acc_Intep_HomePosition, MP_time_Intep_HomePosition, Mode_det_Jq_J_HomePosition ] = ...
                                                                                                    MotionPlanningSingleMode(Mode_previous,PosOri_previous,q0q1q2_previous,...
...
BaseMotorValue = [q0, 0*pi/180, 0, 0]; %zeros(1, TotalSteps+1);
for i = 1:TotalSteps
