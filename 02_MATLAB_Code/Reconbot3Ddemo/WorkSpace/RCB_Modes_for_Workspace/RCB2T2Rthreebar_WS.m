classdef RCB2T2Rthreebar_WS
    ...
    methods
        ...
        function obj = RCB2T2Rthreebar_WS(pos,q11q12q14q23,L1,L2)
            if nargin > 0
                obj.l1 = L1;
                obj.l2 = L2;
                obj.pos = pos;
        ...
        function [p, EulerAngle_q11_theta, ABC_FeasibleSolution, q1q2_FeasibleSolution, WSvalue] = RCB_2T2R_ThreeBar_IK(obj)
            % Mechanism transfers into Serial Three-bar Linkage:  [1 1 1 0 1 1]
            % p = [x, 0, z, [], beta, 0]
            L1 = obj.l1;
            L2 = obj.l2;
            po = obj.pos;
            ...
            %% ---------- Calculate rotation matrix of Three-bar modes ----------
