classdef RCB3T1RSingularityA1C1_WS
...
%     end
    ...
    methods
        ...
        function obj = RCB3T1RSingularityA1C1_WS(pos,q11q12q21q22,L1,L2)% constructor
            if nargin > 0
                obj.l1 = L1;
                obj.l2 = L2;
                obj.pos = pos;
        ...
        function [p, EulerAngle_q11_theta, ABC_FeasibleSolution, q1q2_FeasibleSolution, WSvalue] = RCB_3T1R_SingularityA1C1_IK(obj)
        ...
        function [p, ABC, q1q2] = RCB_3T1R_SingularityA1C1_FK(obj)
